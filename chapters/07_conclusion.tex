...
Moreover, prediction latency should also be benchmarked and potentially improved through native code compilation using the \texttt{lleaves} framework~\parencite{t3}.
