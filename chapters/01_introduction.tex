...
T3 achieves state-of-the-art accuracy while being orders of magnitude faster than neural network models.
...
Our results show that the adapted model generalizes well.
Furthermore, on the Join Order Benchmark, our model outperforms an earlier T3-based PostgreSQL implementation by Wehrstein et al.~\parencite{jobcomplex}, demonstrating the importance of PostgreSQL-native features.
