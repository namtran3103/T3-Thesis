...
\begin{table}[htpb]
  ...
  \begin{tabular}{lc}
    ...
    \bottomrule
  \end{tabular}
  \caption[Median Q-Error on JOB across different Models]{Median Q-Error on the Join Order Benchmark (JOB) across different models, data from Wehrstein et al.~\parencite{jobcomplex}. Our model reports the 57th-best (p75) Q-Error value, matching the median of the other models. Estimated cardinalities. }\label{tab:median_qerror_job}
\end{table}
