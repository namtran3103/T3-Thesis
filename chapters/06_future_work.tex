...
PostgreSQL's iterator model causes per-node timings to overlap across pipeline boundaries.
Future work could investigate this issue and provide mitigation approaches apart from the currently applied normalization.
Subsequently, this could provide more accurate per-pipeline labels and could make the per-pipeline and per-tuple
prediction variants more accurate.
