...
Therefore, a future direction is to design the feature vector directly at the query level,
...
More broadly, to assess the importance of individual features,
future work can use LightGBM's built-in feature importance scores
to identify which of the 153 dimensions drive the model's predictions.
