...
Therefore, the \texttt{plan\_parameters} are kept in the converted tree (\texttt{pg} payload entry) for feature extraction.
...
\begin{enumerate}
  ...
  Thus, they are represented as a structured predicate tree in the \texttt{filter\_columns} field of the ZeroShot \texttt{parsed\_plans} format~\parencite{zeroshot}.
